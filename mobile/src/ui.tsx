...
const ky: Record<string, string> = {
  ...
  'Быстро и комфортно': 'Тез жана ыңгайлуу',
  'Грузовой': 'Жүк ташуу',
  ...
  'Дом': 'Үй',
  'Работа': 'Жумуш',
  'Адрес дома': 'Үйдүн дареги',
  'Адрес работы': 'Жумуштун дареги',
  'Введите адрес': 'Даректи киргизиңиз',
  'Выберите адрес': 'Даректи тандаңыз',
  'Введите улицу или выберите точку на карте.': 'Көчөнү киргизиңиз же картадан жерди тандаңыз.',
  'Начните вводить улицу или название места.': 'Көчөнү же жердин атын жаза баштаңыз.',
  'Не удалось сохранить адрес': 'Дарек сакталган жок',
  'Удерживайте, чтобы изменить адрес': 'Даректи өзгөртүү үчүн басып туруңуз',
  'Избранное': 'Тандалгандар',
  'добавить адрес': 'дарек кошуу',
  'Добавить': 'Кошуу',
  'Открыть активный заказ еды': 'Активдүү тамак буюртмасын ачуу',
  'Заказ уже в работе': 'Буюртма даярдалып жатат',
  'Посмотреть статус доставки': 'Жеткирүүнүн абалын көрүү',
  'Вкуснее\nкаждый день': 'Күн сайын\nдаамдуураак',
  'Скидки до 30%\nна доставку еды': 'Тамак жеткирүүгө\n30% чейин арзандатуу',
  'Заказать еду': 'Тамак буюртма берүү',
  'Скоро появится': 'Жакында пайда болот',
  'Баннер': 'Баннер',
  'из': '/',
  'Строим маршрут': 'Багыт түзүлүүдө',
  'Вы отклонились от маршрута': 'Багыттан чыгып кеттиңиз',
  'Маршрут недоступен': 'Багыт жеткиликсиз',
  'Готовим навигацию': 'Навигация даярдалууда',
  'Проверить местоположение': 'Жайгашкан жерди текшерүү',
  'Повторить': 'Кайталоо',
  'Проверить': 'Текшерүү',
  'Стоп': 'Токто',
  'Уступи дорогу': 'Жол бер',
  'Ограничение 60': 'Ылдамдык чеги 60',
  'Пешеходный переход': 'Жөө адамдар өтүүчү жер',
  'Камера скорости': 'Ылдамдык камерасы',
  'Светофор': 'Светофор',
  'уже позади': 'артта калды',
  'рядом': 'жанында',
  'Очистить поиск': 'Издөөнү тазалоо',
  'Открыть корзину': 'Себетти ачуу',
  'товаров': 'товар',
  'Корзина': 'Себет',
  'Ваш заказ': 'Сиздин буюртмаңыз',
  'Рестораны': 'Ресторандар',
  'Ресторан, кухня или блюдо': 'Ресторан, ашкана же тамак',
  'Суши': 'Суши',
  'Пицца': 'Пицца',
  'Фастфуд': 'Тез тамак',
  'Национальная кухня': 'Улуттук ашкана',
  'Ищем рестораны…': 'Ресторандарды издеп жатабыз…',
  'Не удалось загрузить рестораны': 'Ресторандар жүктөлгөн жок',
  'мин': 'мүн',
  'Бесплатная доставка': 'Акысыз жеткирүү',
  'Доставка': 'Жеткирүү',
  'Рестораны скоро появятся': 'Ресторандар жакында пайда болот',
  'Ничего не найдено': 'Эч нерсе табылган жок',
  'Мы готовим каталог. Загляните немного позже.': 'Каталогду даярдап жатабыз. Бир аздан кийин караңыз.',
  'Попробуйте другую кухню или измените запрос.': 'Башка ашкананы тандаңыз же издөөнү өзгөртүңүз.',
  'Поиск по меню': 'Менюдан издөө',
  'Информация о ресторане': 'Ресторан тууралуу маалымат',
  'Бесплатная доставка от': 'Акысыз жеткирүү башталат',
  'Адрес': 'Дарек',
  'Блюда не найдены': 'Тамактар табылган жок',
  'Измените запрос.': 'Издөөнү өзгөртүңүз.',
  'Выберите другую категорию.': 'Башка категорияны тандаңыз.',
  'Закрыть информацию о ресторане': 'Ресторан маалыматын жабуу',
  'бесплатно': 'акысыз',
  'Минимальный заказ': 'Минималдуу буюртма',
  'Без минимальной суммы заказа': 'Минималдуу сумма жок',
  'Демонстрационный ресторан. Заказы не передаются в реальное заведение.': 'Үлгү ресторан. Буюртмалар чыныгы ресторанга жөнөтүлбөйт.',
  'Выберите количество': 'Санын тандаңыз',
  'Комплектация и добавки': 'Курамы жана кошумчалар',
  'По желанию': 'Каалоо боюнча',
  'Бесплатно': 'Акысыз',
  'Добавить в корзину': 'Себетке кошуу',
  'Блюдо временно недоступно': 'Тамак убактылуу жеткиликсиз',
  'Пока ничего не сохранено': 'Азырынча эч нерсе сакталган жок',
  'Нажмите на сердечко у ресторана или блюда, чтобы найти его здесь.': 'Ресторанды же тамакты бул жерге сактоо үчүн жүрөкчө белгисин басыңыз.',
  'Блюда': 'Тамактар',
  'ресторан': 'ресторан',
  'блюдо': 'тамак',
  'Убрать из избранного': 'Тандалгандардан алып салуу',
  'Добавить в избранное': 'Тандалгандарга кошуу',
  'Дождитесь завершения оформления заказа': 'Буюртма аяктаганча күтүңүз',
  'Назад недоступно: заказ оформляется': 'Артка кайтуу мүмкүн эмес: буюртма жөнөтүлүүдө',
  'Очистить корзину': 'Себетти тазалоо',
  'Заказ из ресторана': 'Ресторандан буюртма',
  'за шт.': 'даанасы',
  'Нет в наличии': 'Азыр жок',
  'порция': 'порция',
  'порций': 'порция',
  'по одной к каждой порции блюда': 'ар бир тамакка бирден',
  'Оставить': 'Калтыруу',
  'Убрать': 'Алып салуу',
  'шт.': 'даана',
  'Состав меню изменился. Уберите недоступные блюда.': 'Меню өзгөрдү. Жеткиликсиз тамактарды алып салыңыз.',
  'Оформить заказ': 'Буюртманы тариздөө',
  'Меню изменилось': 'Меню өзгөрдү',
  'В корзине пока пусто': 'Себет азырынча бош',
  'Сохранённые блюда больше недоступны. Очистите корзину и выберите другие.': 'Сакталган тамактар жеткиликсиз. Себетти тазалап, башкаларын тандаңыз.',
  'Добавьте любимые блюда из меню ресторана.': 'Ресторандын менюсунан сүйүктүү тамактарды кошуңуз.',
  'Выбрать блюда': 'Тамактарды тандоо',
  'Оформление заказа': 'Буюртманы тариздөө',
  'Адрес доставки': 'Жеткирүү дареги',
  'Укажите адрес': 'Даректи көрсөтүңүз',
  'Изменить адрес доставки': 'Жеткирүү дарегин өзгөртүү',
  'Изменить': 'Өзгөртүү',
  'Комментарий к заказу': 'Буюртмага комментарий',
  'Например: домофон, подъезд, этаж': 'Мисалы: домофон, кире бериш, кабат',
  'Наличными курьеру': 'Курьерге накталай',
  'Оплата картой': 'Карта менен төлөө',
  'Онлайн оплата': 'Онлайн төлөм',
  'Пока недоступно': 'Азырынча жеткиликсиз',
  'Включая доставку': 'Жеткирүү менен',
  'Закрыть адрес': 'Даректи жабуу',
  'Улица и номер дома': 'Көчө жана үйдүн номери',
  'Сохранить адрес': 'Даректи сактоо',
  'Заказ': 'Буюртма',
  'Ожидаем подтверждения': 'Ырастоону күтүүдөбүз',
  'Заказ подтверждён': 'Буюртма ырасталды',
  'Ваш заказ готовится': 'Буюртмаңыз даярдалууда',
  'Можно забирать': 'Алып кетсеңиз болот',
  'Заказ готов': 'Буюртма даяр',
  'Курьер уже в пути': 'Курьер жолдо',
  'Заказ получен': 'Буюртма алынды',
  'Заказ доставлен': 'Буюртма жеткирилди',
  'Принят': 'Кабыл алынды',
  'Готовится': 'Даярдалууда',
  'Доставлен': 'Жеткирилди',
  'Ресторан принимает ваш заказ': 'Ресторан буюртмаңызды кабыл алууда',
  'Передаём заказ курьеру': 'Буюртманы курьерге өткөрүп жатабыз',
  'Курьер скоро будет у вас': 'Курьер жакында сизге келет',
  'Спасибо за заказ!': 'Буюртмаңыз үчүн рахмат!',
  'Ресторан отменил заказ': 'Ресторан буюртманы жокко чыгарды',
  'Ресторан уже готовит блюда': 'Ресторан тамактарды даярдап жатат',
  'поз.': 'даана',
  'АДРЕС ДОСТАВКИ': 'ЖЕТКИРҮҮ ДАРЕГИ',
  'Адрес не указан': 'Дарек көрсөтүлгөн эмес',
  'Связаться с рестораном': 'Ресторан менен байланышуу',
  'Контакт ресторана': 'Ресторандын байланышы',
  'Ресторан пока не указал номер телефона.': 'Ресторан азырынча телефон номерин көрсөткөн жок.',
  'Нажмите, чтобы обновить статус': 'Абалын жаңыртуу үчүн басыңыз',
  'Тестовый заказ · ресторан из макетов': 'Сыноо буюртмасы · үлгү ресторан',
  'Заказов пока нет': 'Азырынча буюртмалар жок',
  'Здесь появятся ваши заказы из ресторанов.': 'Ресторандардан берген буюртмаларыңыз бул жерде пайда болот.',
  'Доставка временно недоступна. Попробуйте обновить раздел немного позже.': 'Жеткирүү убактылуу жеткиликсиз. Бир аздан кийин кайра жаңыртыңыз.',
  'Количество порций': 'Порциялардын саны',
  'Можно добавить не больше': 'Кошууга боло турган эң көп саны',
  'порций одного блюда с одинаковыми добавками.': 'бир тамактын бирдей кошумчалары менен порциясы.',
  'Заказ из другого ресторана': 'Башка ресторандан буюртма',
  'В одном заказе могут быть блюда только из одного ресторана. Заменить содержимое корзины?': 'Бир буюртмага бир эле ресторандын тамактарын кошууга болот. Себетти алмаштырасызбы?',
  'Заменить': 'Алмаштыруу',
  'Очистить корзину?': 'Себетти тазалайсызбы?',
  'Все блюда и добавки будут удалены из корзины.': 'Бардык тамактар жана кошумчалар себеттен өчүрүлөт.',
  'Очистить': 'Тазалоо',
  'Без этой добавки получится больше': 'Бул кошумчасыз саны ашып кетет:',
  'одинаковых порций. Сначала уменьшите количество блюда.': 'бирдей порция. Адегенде тамактын санын азайтыңыз.',
  'Открыть допуски и документы': 'Уруксаттарды жана документтерди ачуу',
  'Главная': 'Башкы бет',
  'Заказать такси': 'Такси чакыруу',
  'Доставка и грузовой': 'Жеткирүү жана жүк ташуу',
  'Мои заказы еды': 'Тамак буюртмаларым',
  'Допуски и документы': 'Уруксаттар жана документтер',
  'Закрыть поиск': 'Издөөнү жабуу',
  'в пути': 'жолдо',
  'Расчёт стоимости': 'Баасын эсептөө',
  'Оплата водителю после поездки': 'Сапардан кийин айдоочуга төлөө',
  'Данные водителя загружаются': 'Айдоочунун маалыматы жүктөлүүдө',
  'Строим маршрут до клиента…': 'Кардарга багыт түзүлүүдө…',
  'Ожидаем GPS водителя': 'Айдоочунун GPS маалыматын күтүп жатабыз',
  'Отправитель': 'Жөнөтүүчү',
  'От двери до двери': 'Эшиктен эшикке чейин',
  'К новым заказам': 'Жаңы буюртмаларга',
  'Пассажир увидит, что заказ отменён.': 'Жүргүнчү буюртма жокко чыгарылганын көрөт.',
  'прибытие ≈': 'келүү ≈',
  'Включить навигацию и положение в фоне': 'Фондо навигацияны жана жайгашкан жерди күйгүзүү',
  'до клиента': 'кардарга чейин',
  'до цели': 'максатка чейин',
  'по прямой': 'түз сызык боюнча',
  'мин бесплатно после начала': 'мүн башталгандан кийин акысыз',
  'Затем': 'Андан кийин',
  'Указать адреса': 'Даректерди көрсөтүү',
  'Заказать доставку': 'Жеткирүүгө буюртма берүү',
  'Свернуть параметры': 'Жөндөөлөрдү жыйноо',
  'Параметры доставки': 'Жеткирүү параметрлери',
  'Адрес отправки': 'Жөнөтүү дареги',
  'Определяем местоположение': 'Жайгашкан жерди аныктап жатабыз',
  'Куда доставить': 'Кайда жеткирүү керек',
  'Закрыть параметры доставки': 'Жеткирүү параметрлерин жабуу',
  'Стоимость после маршрута': 'Баасы багыт түзүлгөндөн кийин',
  'Запланировать поездку': 'Сапарды пландоо',
  'Подача через 30 минут': '30 мүнөттөн кийин келет',
  'Водитель заберёт и передаст груз у двери': 'Айдоочу жүктү эшиктен алып, эшикке жеткирет',
  'Укажите важные детали': 'Маанилүү маалыматты жазыңыз',
  'Закрыть способы оплаты': 'Төлөм ыкмаларын жабуу',
  'Расчёт цены': 'Баасын эсептөө',
  'Груз': 'Жүк',
  'от двери до двери': 'эшиктен эшикке чейин',
  'Суши · Роллы': 'Суши · Роллдор',
  'Бургеры': 'Бургерлер',
  'Курица': 'Тоок эти',
  'Закуски': 'Жеңил тамактар',
  'Роллы': 'Роллдор',
  '1 шт.': '1 даана',
  ...
  '© Участники OpenStreetMap ↗': '© OpenStreetMap катышуучулары ↗', 'Политика конфиденциальности ↗': 'Купуялык саясаты ↗',
