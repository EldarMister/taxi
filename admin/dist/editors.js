...
export function newRestaurant() {
  ...
  return { id, active: false, isDemo: false, sortOrder: 0, catalog: { id, name: '', rating: 0, reviewCount: 0, cuisine: '', categories: [], etaMin: 30, etaMax: 45, deliveryFee: 0, freeDeliveryThreshold: 0, minimumOrder: 0, address: '', phone: null, imageKey: '', heroImageKey: '', menuCategories: ['Основное'], dishes: [], options: [], isDemo: false } };
}
